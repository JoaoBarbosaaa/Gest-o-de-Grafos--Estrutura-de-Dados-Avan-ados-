...
typedef struct Adjacencias {
    int id;	                         /**< Identificador do vértice de destino da aresta. */
    int peso;                        /**< Peso da aresta. */
    struct Adjacencias* next;        /**< Apontador para a próxima aresta na lista de adjacências. */
}Adjacencias;


typedef struct Vertices {
    int id;                          /**< Identificador do vértice. */
    Adjacencias* proxAdj;            /**< Apontador para a lista de adjacências do vértice. */
    struct Vertices* proxVertice;    /**< Apontador para o próximo vértice na lista de vértices. */
} Vertices;


typedef struct Grafo {
    Vertices* inicioGrafo;            /**< Apontador para o início da lista de vértices do grafo. */
} Grafo;
